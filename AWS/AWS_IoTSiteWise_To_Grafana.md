...
Existem inúmeros tipos de visualização no grafana para poder criar uma dashboard. O template do caso utilizado está na pasta [Backup Dashboard grafana AWS](/BackupDashboardgrafanaAWS).
